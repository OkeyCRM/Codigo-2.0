...
// Esperar que cargue el bloque de estrellas y luego insertar el botón debajo
const esperarEstrellas = setInterval(() => {
  const estrellas = document.querySelector('.jdgm-preview-badge') || document.querySelector('.star-rating') || document.querySelector('.yotpo-bottomline');
  if (estrellas) {
    estrellas.insertAdjacentElement('afterend', botonEnvio);
    clearInterval(esperarEstrellas);
  }
}, 300);
