...
const envioFinanciacionStyle = document.createElement('style');
envioFinanciacionStyle.innerHTML = `
  .ff-envios-box {
    max-width: 480px;
    margin: 40px auto;
    font-family: 'Helvetica Neue', sans-serif;
...
`;
document.head.appendChild(envioFinanciacionStyle);