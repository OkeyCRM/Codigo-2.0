...
// Detectar correctamente el contenedor debajo del precio del producto en Tiendanube
let containerBundle = document.querySelector('.product__price')?.parentNode;
if (!containerBundle) {
  containerBundle = document.getElementsByClassName('price-container')[0];
}
