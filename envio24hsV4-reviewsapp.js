...
// Insertar debajo de reviewsapp-widgetContainer
const esperarContenedor = setInterval(() => {
  const target = document.querySelector('.reviewsapp-widgetContainer');
  if (target) {
    target.insertAdjacentElement('afterend', botonEnvio);
