...
style.innerHTML = `
  ...
  /* BLOQUE ELEGIRNOS ESTILOS MODIFICADOS */
  .ff-elegir-box {
    max-width: 480px;
    margin: 40px auto;
    padding: 30px 20px;
  ...
  .ff-elegir-title {
    ...
    display: inline-block;
    padding-bottom: 5px;
    border-bottom: 4px solid #C6F3D2; /* subrayado pastel */
  }
  ...
  .ff-elegir-item:nth-child(3)::after {
    content: "🛡️";
  }

  .ff-elegir-item:nth-child(4)::after {
    content: "💆";
  }
